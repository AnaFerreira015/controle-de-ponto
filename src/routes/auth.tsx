...
function GoogleIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 48 48" width="18" height="18" {...props}>
      ...
      <path fill="#4CAF50" d="M24 44c5.2 0 9.9-2 13.5-5.2l-6.2-5.3C29.2 34.9 26.7 36 24 36c-5.3 0-9.7-3.3-11.3-8l-6.5 5C9.6 39.6 16.2 44 24 44z"/>
      <path fill="#1976D2" d="M43.6 20.5H42V20H24v8h11.3c-.8 2.2-2.2 4.2-4 5.6l6.2 5.3C41.9 34.5 44 29.6 44 24c0-1.2-.1-2.3-.4-3.5z"/>
    </svg>
  );
}
            ...
            <CardContent>
              ...
              <div className="mt-5 space-y-3">
                <Button
                  ...
                  aria-label={tab === "login" ? "Entrar com Google" : "Criar conta com Google"}
                >
                  <GoogleIcon aria-hidden="true" />
                  <span>{tab === "login" ? "Entrar com Google" : "Continuar com Google"}</span>
                </Button>
